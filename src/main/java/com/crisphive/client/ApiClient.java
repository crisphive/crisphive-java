...
import com.crisphive.client.auth.Authentication;
import com.crisphive.client.auth.HttpBasicAuth;
import com.crisphive.client.auth.HttpBearerAuth;
import com.crisphive.client.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://api.crisphive.com/v1";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://api.crisphive.com/v1",
      "Production",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.crisphive.com/v1
     ...
     * @return a {@link com.crisphive.client.ApiClient} object
     */
    ...
    */
     ...
     * @throws com.crisphive.client.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.crisphive.client.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.crisphive.client.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.crisphive.client.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.crisphive.client.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.crisphive.client.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.crisphive.client.ApiException If fails to update the parameters
     */
     ...
     * @throws com.crisphive.client.ApiException If fail to serialize the request body object into a string
     */
